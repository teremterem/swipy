...
def user_dicts() -> List[Dict[Text, Any]]:
    return [
        ...
        },
        {
            ...
            'state': 'ok_to_chitchat',
            'partner_id': None,
            'exclude_partner_ids': ['excluded_partner1', 'ok_to_chitchat_id3', 'excluded_partner2'],
            'newbie': False,
            'state_timestamp': Decimal(0),
            'state_timestamp_str': None,
            'state_timeout_ts': Decimal(0),
        ...
        },
        {
            ...
            'state': 'ok_to_chitchat',
            'partner_id': None,
            'exclude_partner_ids': ['excluded_partner1', 'excluded_partner2', 'ok_to_chitchat_id3'],
            'newbie': False,
            'state_timestamp': Decimal(0),
            'state_timestamp_str': None,
            'state_timeout_ts': Decimal(0),
        ...
        },
        {
            ...
            'state': 'roomed',
            'partner_id': 'some_partner_id',
            'exclude_partner_ids': ['ok_to_chitchat_id3', 'some_excluded_partner'],
            'newbie': True,
            'state_timestamp': Decimal(0),
            'state_timestamp_str': None,
