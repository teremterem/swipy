...
def user_dicts() -> List[Dict[Text, Any]]:
    return [
        ...
        {
            'user_id': 'ok_to_chitchat_id2_2_3',
            'state': 'ok_to_chitchat',
            'partner_id': None,
            'roomed_partner_ids': [],
        ...
        },
        {
            ...
            'state': 'roomed',
            'partner_id': 'some_partner_id',
            'seen_partner_ids': ['some_excluded_partner', 'ok_to_chitchat_id3'],
            'rejected_partner_ids': [],
            'newbie': True,
            'state_timestamp': Decimal(0),
            'state_timestamp_str': None,
            'state_timeout_ts': Decimal(1624000009),
            'state_timeout_ts_str': None,
            'activity_timestamp': Decimal(1623000009),  # more resent but the seeker ('ok_to_chitchat_id3') was seen
            'activity_timestamp_str': None,
            'notes': '',
            'deeplink_data': '',
            'native': 'unknown',
