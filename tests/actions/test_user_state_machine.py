...
expected_more_narrow_transitions = [
    ...
    ('reject_partner', 'waiting_partner_confirm', None, 'previous_partner_id', 'previous_partner_id'),
    ...
    ('reject_invitation', 'waiting_partner_confirm', None, 'previous_partner_id', 'previous_partner_id'),
