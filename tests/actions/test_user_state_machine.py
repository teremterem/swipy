...
expected_more_narrow_transitions = [
    ...
    ('wait_for_partner', 'asked_to_join', 'waiting_partner_confirm', 'previous_partner_id', 'previous_partner_id'),
    ...
    ('become_asked', 'waiting_partner_join', 'asked_to_confirm', 'previous_partner_id', 'previous_partner_id'),
    ...
    ('become_asked', 'join_timed_out', 'asked_to_join', 'previous_partner_id', 'new_partner_id'),
    ('become_asked', 'confirm_timed_out', 'asked_to_join', 'previous_partner_id', 'new_partner_id'),
    ...
    ('join_room', 'waiting_partner_confirm', 'previous_partner_id', 'roomed', 'previous_partner_id'),
    ('join_room', 'asked_to_join', None, 'previous_partner_id', 'previous_partner_id'),
    ('join_room', 'asked_to_confirm', 'roomed', 'previous_partner_id', 'previous_partner_id'),
