...
expected_more_narrow_transitions = [
    ...
    ('reject', 'new', None, 'previous_partner_id'),
    ('reject', 'wants_chitchat', None, 'previous_partner_id'),
    ...
    ('reject', 'join_timed_out', None, 'previous_partner_id'),
    ('reject', 'confirm_timed_out', None, 'previous_partner_id'),
    ('reject', 'do_not_disturb', None, 'previous_partner_id'),

    ('time_out', 'new', None, 'previous_partner_id'),
    ('time_out', 'wants_chitchat', None, 'previous_partner_id'),
    ...
    ('time_out', 'join_timed_out', None, 'previous_partner_id'),
    ('time_out', 'confirm_timed_out', None, 'previous_partner_id'),
    ('time_out', 'do_not_disturb', None, 'previous_partner_id'),
]
